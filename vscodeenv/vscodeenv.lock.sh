...
code --install-extension eamodio.gitlens@11.3.0 --force
code --install-extension golang.go@0.23.0 --force
...
code --install-extension ms-vscode-remote.remote-containers@0.163.2 --force
...
code --install-extension ms-vsliveshare.vsliveshare@1.0.3912 --force
